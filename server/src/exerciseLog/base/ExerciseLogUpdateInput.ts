...
class ExerciseLogUpdateInput {
  ...
  @ApiProperty({
    required: false,
    type: () => WorkoutUpdateManyWithoutExerciseLogsInput,
  })
  @ValidateNested()
  @Type(() => WorkoutUpdateManyWithoutExerciseLogsInput)
  @IsOptional()
  @Field(() => WorkoutUpdateManyWithoutExerciseLogsInput, {
    nullable: true,
  })
  workouts?: WorkoutUpdateManyWithoutExerciseLogsInput;
}
export { ExerciseLogUpdateInput };
